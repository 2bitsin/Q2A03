...
out/ver/libtestbench.a out/ver/Vtestbench.h: ver/core.sv ver/core_alu.sv ver/core_alu_ctl.sv ver/register.sv ver/cycles.svi 
	verilator --cc -Mdir out/ver -y ver --top-module core core_alu_ctl.sv $< -CFLAGS "$(CFLAGS)" $(VFLAGS)
